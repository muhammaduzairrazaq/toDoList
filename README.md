...
In this project, I have created an interactive todo list where you can add, remove you daily tasks and it uses localstorage.
...
- cd my-folder
- git clone git@github.com:muhammaduzairrazaq/toDoList.git
